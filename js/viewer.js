var cache = {},                      // Cache object
  request,                           // Latest image to be requested
  $current,                          // Image currently being shown 
  $frame = $('.viewer');       // Container for image
...
var synopsis = {"YoungJustice": "Young Justice - Infiltrator <br><br> Artemis faces an uphill battle winning over her new teammates, as she tries to fill Red Arrow's boots on a mission he initiated: saving a brilliant young scientist from the League of Shadows.", "ManOfSteel":"Man of Steel <br><br> A young boy learns that he has extraordinary powers and is not of this Earth. As a young man, he journeys to discover where he came from and what he was sent here to do. But the hero in him must emerge if he is to save the world from annihilation and become the symbol of hope for all mankind."} 

$('a').click(function(){
    $('.details').text('');
    $('.details').append(synopsis[this.id]);
});
